...
function bdtask_invoice_quantity_calculate(item) {
    var tax_rate = $("#tax_rate" + item).val();
...
if (quantity > 0 || discount > 0) {
        ...
        $("#total_price_" + item).val(n),
				...
				var tax_amount = (n) * $("#total_tax_" + item).val();
            $("#tax_amount" + item).val(tax_amount);
    }
