                ...
                <div class="row" id="">
                    <div class="col-sm-6">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="dtpFromDate" value="<?php date('Y-m-d')?>" placeholder="<?php echo display('from_date') ?>" class="datepicker form-control" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  name="dtpToDate" value="<?php date('Y-m-d')?>" placeholder="<?php echo display('to_date') ?>" class="datepicker form-control" required>
                            </div>
                        </div>
                        <div class="form-group row">
