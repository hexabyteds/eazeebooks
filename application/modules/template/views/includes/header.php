...
<span class="top-fixed-link">
     ...
     <?php }?>
        ...
        <?php if($this->permission1->method('customer_receive','create')->access()){ ?>
           <a href="<?php echo base_url('customer_receive')?>" class="btn btn-success btn-outline"><i class="fa fa-user-circle" aria-hidden="true"></i> <?php echo display('customer_receive')?></a>
       <?php } ?>
      
  <?php if($this->permission1->method('supplier_payment','create')->access()){ ?>
          <a href="<?php echo base_url('supplier_payment')?>" class="btn btn-success btn-outline"><i class="fa fa-credit-card-alt" aria-hidden="true"></i> <?php echo display('supplier_payment')?></a>
      <?php } ?>

<?php if($this->permission1->method('add_purchase','create')->access()){ ?>
          <a href="<?php echo base_url('add_purchase')?>" class="btn btn-success btn-outline"><i class="fa fa-shopping-cart" aria-hidden="true"></i> <?php echo display('purchase') ?></a>
 <?php } ?>
</span>
