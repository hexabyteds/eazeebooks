 ...
 <div class="row">
            <div class="col-sm-5" style="width: 800px; float: left;">
                    ...
                    <div id="printableArea">
                        <div class="panel-body">
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <table border="0" width="100%">
                                                ...
                                                <tr>
                                                    <td align="center"><b>Name: <?php echo $customer_name;?></b><br>
                           ...
                           <div class="col-sm-4 text-left invoice-address">
                                            <a href="">
                                   <img class="barcode-img" src="<?php echo base_url();?>my-assets/image/sales_qr/<?php echo $invoice_id?>.png" style="margin-left: 245px;">
                                   </a>
                                    </div>
                        </div>
                    </div>
